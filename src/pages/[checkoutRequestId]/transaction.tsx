...
import UsFlagImage from '@src/assets/images/us-flag.png';
import VisaIcon from '@src/assets/images/visa-icon.png';
import { useCheckout } from "@src/context/checkout";
import { calcTip } from "@src/utils";
import Image from "next/image";
const explorerUri = process.env.NEXT_PUBLIC_EXPLORER_URL || 'https://mumbai.polygonscan.com'
    ...
    <div className="flex-1 flex flex-col justify-between gap-2">
      <div>
        ...
        <div className="flex w-full">
          ...
          <div className='border-2 border-white rounded-md h-11 w-24 ml-2 flex items-center justify-center text-white text-lg shadow-sm shadow-white'>
            <Image src={UsFlagImage} alt='' className="flag mr-2" />
            USD
          </div>
        </div>
      </div>
      <div>
        ...
        <div className="flex w-full">
          ...
          <div className='border-2 border-white rounded-md h-11 w-24 ml-2 flex items-center justify-center text-white text-lg shadow-sm shadow-white'>
            <Image src={VisaIcon} alt='' className="!w-8" />
          </div>
        </div>
      </div>
      <div>
